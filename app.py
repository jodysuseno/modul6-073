...
def predict_model_comparation():
    ...
    model = load_model('static/MLModule/Model2Prak4.h5')
    ...
    modelh = load_model('static/MLModule/model2hparamPrak4.h5')
...
def predict_select_image():
    ...
    model_dict = {
        'pureModel'         :   'static/MLModule/Model2Prak4.h5',
        'hyperModel'        :   'static/MLModule/model2hparamPrak4.h5',
        }
